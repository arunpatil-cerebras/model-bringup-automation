...
base_run_sh = """#!/bin/bash python3 run.py CSX --params {config_file} --model_dir {log_dir} --mode train --compile_only --num_act_servers 1 --mgmt_address localhost:9000 
"""
...
run_sh_dir = "generated_run_scripts"
